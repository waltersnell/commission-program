...
INSERT INTO "new_MembershipOpportunity" ("clientId", "closureNote", "closureReason", "createdAt", "followUpNotes", "followUpOwnerId", "followUpStatus", "id", "lastFollowUpDate", "locationId", "nextFollowUpDate", "proposedPrimaryCloserId", "proposedSupportCloserId", "status", "updatedAt") SELECT "clientId", "closureNote", "closureReason", "createdAt", "followUpNotes", "followUpOwnerId", "followUpStatus", "id", "lastFollowUpDate", "locationId", "nextFollowUpDate", "proposedPrimaryCloserId", "proposedSupportCloserId", "status", "updatedAt" FROM "MembershipOpportunity";
