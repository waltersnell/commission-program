...
- Client Lookup: lists First Visit and Sale Date independently. Administrators can correct a recorded sale date in the client editor; the app recalculates first-visit credit status and writes the date change to Audit History.
