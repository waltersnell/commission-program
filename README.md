...
- Dashboard: shows active-month metrics, Recent Activity, and Estimated Commissions for all active staff using approved and pending sales. Monthly sales, pending approvals, and location totals use the active month and include all recorded sales. Estimated Commissions sorts Front Desk and Sales staff by highest commission first, then Therapists by highest commission, and fits without horizontal scrolling through iPad widths.
